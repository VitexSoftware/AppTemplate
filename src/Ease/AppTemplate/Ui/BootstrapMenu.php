...
class BootstrapMenu extends \Ease\TWB4\Navbar {
    ...
    public function __construct($name = null, $content = null,
        ...
        parent::__construct(new \Ease\Html\ImgTag('images/project-logo.svg', 'Project logo', ['height' => 30, 'class' => 'img-rounded d-inline-block align-top']), 'main-menu', ['class' => 'navbar-fixed-top' . (array_key_exists('class', $properties) ? $properties['class'] : '')]);
        ...
        if (\Ease\Shared::user()->isLogged() === false) {
            ...
            $this->addMenuItem(new \Ease\TWB4\LinkButton('createaccount.php', _('Singn On'), 'success my-2 my-sm-0'), true, 'right');
            $this->addMenuItem(new \Ease\TWB4\LinkButton('passwordrecovery.php', _('Password recovery'), 'warning my-2 my-sm-0'), true, 'right');
